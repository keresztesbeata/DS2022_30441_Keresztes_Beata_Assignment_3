...
goog.exportSymbol('proto.MsgReadNotification', null, global);
 ...
 * @constructor
 */
proto.MsgReadNotification = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.MsgReadNotification.repeatedFields_, null);
};
goog.inherits(proto.MsgReadNotification, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.MsgReadNotification.displayName = 'proto.MsgReadNotification';
}
 ...
 * @const
 */
proto.MsgReadNotification.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.MsgReadNotification.prototype.toObject = function(opt_includeInstance) {
  return proto.MsgReadNotification.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.MsgReadNotification} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.MsgReadNotification.toObject = function(includeInstance, msg) {
  var f, obj = {
    user: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.MsgReadNotification}
 */
proto.MsgReadNotification.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.MsgReadNotification;
  return proto.MsgReadNotification.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.MsgReadNotification} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.MsgReadNotification}
 */
proto.MsgReadNotification.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.MsgReadNotification.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.MsgReadNotification.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.MsgReadNotification} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.MsgReadNotification.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUser();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.MsgReadNotification.prototype.getUser = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.MsgReadNotification} returns this
 */
proto.MsgReadNotification.prototype.setUser = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<number>}
 */
proto.MsgReadNotification.prototype.getIdsList = function() {
 ...
 * @return {!proto.MsgReadNotification} returns this
 */
proto.MsgReadNotification.prototype.setIdsList = function(value) {
 ...
 * @return {!proto.MsgReadNotification} returns this
 */
proto.MsgReadNotification.prototype.addIds = function(value, opt_index) {
 ...
 * @return {!proto.MsgReadNotification} returns this
 */
proto.MsgReadNotification.prototype.clearIdsList = function() {
